package com.example.jayantis.icp4temp;
...
public class TranslateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText e1 = (EditText)findViewById(R.id.English);
    ...
    public void translateText(View v) {
        ...
        String transfrom = e1.getText().toString();
        ...
        String getURL = "https://translate.yandex.net/api/v1.5/tr.json/translate?" +
                ...
                "lang=en-" +target+ "&[format=plain]&[options=1]&[callback=set]";//The API service URL
